 ...
 *     <tr>
 *         <td>bundleName</td>
 *         <td>the bundle name can be any value and is used in the {@link mro.fantasy.game.engine.communication.AudioCommunicationService} to access resources from this bundle</td>
 *     </tr>
 *     <tr>
 *         <td>locale</td>
...
public class AudioResourceBundle implements ResourceBundle<AudioResource> {
    ...
    private void loadData(InputStream dataInputStream, Consumer<String> bundleNameCallback) {
        try {
            ...
            Optional.ofNullable(yamlData.get("resources")).orElseThrow(() -> new IllegalArgumentException("There are no resources available"));
            ...
            var orderedResourceList =
                    ((List<Map<String, Object>>) yamlData.get("resources"))                          // load the data from the yaml file
    ...
    public void writeYAML(Writer writer) {
        ...
        yamlRoot.put("resources", yamlResources);
